...
function deliverBroadcast(root, fromId, input) {
  // postRoom already mirrors to messages/ via messageBus.send(... 'broadcast' ...).
  // Do NOT also call messageBus.broadcast here — that wrote a second identical
  // messages/ file (BUG-1: every broadcast shown twice ~1ms apart).
